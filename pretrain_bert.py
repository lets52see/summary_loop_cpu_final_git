...
##
parser.add_argument("--dataset_file", type=str, default="/data/headliner_6M.hdf5", help="Which dataset file to use.")
...
summ = LogPlot("/logs/bert-base-uncased/bert_news.log")
...
for _ in range(n_epochs):
    for ib, batch in enumerate(dataloader):
        ...
        if time.time()-time_save > 60.0:
            ...
            time_save = time.time()
            ##
            torch.save(model.state_dict(), "/models/news_bert_bs"+str(args.optim_every*args.train_batch_size)+".bin")
